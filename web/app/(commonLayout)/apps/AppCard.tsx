...
const AppCard = ({ app, onRefresh }: AppCardProps) => {
  ...
  const isChatOrComplection = app.mode === 'completion' || app.mode === 'chat'
  ...
  return (
    <>
      <div
        ...
        className="relative group col-span-1 bg-gray-50 border-1 border-solid border-transparent rounded-2xl flex flex-col transition-all duration-300 ease-in-out cursor-pointer hover:bg-gray-100 hover:border-gray-200"
      >
        <div className="flex pt-[14px] px-[14px] pb-3 h-[66px] items-center gap-3 grow-0 shrink-0">
          ...
          <div className="grow w-0 py-[1px]">
            <div className="flex items-center text-sm leading-5 font-semibold text-black">
              <div className="truncate" title={app.name}>
                {app.name}
              </div>
            </div>
            <div className="flex items-center text-[10px] leading-[18px] text-gray-500 font-medium">
              {formatTime(app.created_at / 1000, 'MM-DD-YYYY | HH:mm:ss')}
            </div>
          </div>
        </div>
            ...
            <>
              ...
              <div className="!hidden group-hover:!flex shrink-0">
                <CustomPopover
                  ...
                  popupClassName={
                    isChatOrComplection ? '!w-[238px] translate-x-[-110px]' : ''
                  }
