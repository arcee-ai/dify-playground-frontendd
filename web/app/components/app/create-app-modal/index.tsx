    ...
    >
      ...
      <div className="py-2 px-8">
        ...
        <div className="flex">
          <Tooltip
            popupContent={
              <div className="max-w-[280px] leading-[18px] text-xs text-gray-700">
          ...
          >
            <div
              className={cn(
                ...
                showChatBotType &&
                  "border-[1.5px] border-primary-400 hover:border-[1.5px] hover:border-primary-400",
                s["grid-bg-chat"]
              )}
              onClick={() => {
                setAppMode("chat");
          ...
          >
            ...
            >
              ...
              <span className="absolute top-[-3px] right-[-3px] px-1 rounded-[5px] bg-white border border-black/8 text-gray-500 text-[10px] leading-[18px] font-medium">
                BETA
              </span>
            </div>
          </Tooltip>
