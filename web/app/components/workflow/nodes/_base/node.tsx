      ...
      >
        ...
        <div
          className={cn(
            ...
            data.type === BlockEnum.Iteration && 'bg-white',
          )}
        >
          <BlockIcon
