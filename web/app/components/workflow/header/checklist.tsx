...
import { ChecklistSquare } from '@/app/components/base/icons/src/vender/line/general'
  ...
  return (
    ...
    >
      ...
      >
        <div
          className={cn(
            'btn btn-medium btn-icon relative',
        ...
        >
          <div
            className={cn(
              'group flex items-center justify-center w-full h-full rounded-md',
            )}
          >
            <Aicon size={20} icon="icon-checklist" className="a-icon--btn" />
          </div>
