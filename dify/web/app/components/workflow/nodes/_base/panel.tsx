  ...
  return (
    <div
      className={cn(
        ...
        showMessageLogModal
          && '!absolute !mr-0 w-[384px] overflow-hidden -top-[5px] right-[416px] z-0 card-m transition-all fade',
      )}
    >
      <div
        ref={triggerRef}
      ...
      <div
        ref={containerRef}
        className={cn(
          'h-full bg-components-panel-bg shadow-lg border-[0.5px] border-components-panel-border rounded-2xl',
              ...
              {canRunBySingle(data.type) && !nodesReadOnly && (
                ...
                >
                  <Button
                    ...
                    className="btn-icon"
                  >
                    <Aicon icon="icon-play" className="a-icon--btn" size={20} />
                  </Button>
                </Tooltip>
              )}
